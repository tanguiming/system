...
<div class="modal-content animated bounceInRight">
	...
	<form id="wt-forms">
      <input type="hidden" name="id"  value="{{$id}}">
		...
		<div>
                                    <button class="btn btn-primary" id='regsub' type="submit" onclick="update();">保存内容1</button>
                                    <button class="btn btn-primary" id='regsub' type="submit" onclick="window.parent.updates();">保存内容2</button>

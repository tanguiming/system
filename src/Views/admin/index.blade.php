...
<!-- Mirrored from www.zi-han.net/theme/hplus/index_v5.html by HTTrack Website Copier/3.x [XR&CO'2010], Sun, 06 Sep 2015 05:15:37 GMT -->
<head>
...
<body class="gray-bg top-navigation">
    ...
    <!-- Flot -->
    <script src="{{ASSET_URL}}system/hplus/js/plugins/flot/jquery.flot.js"></script>
    <script src="{{ASSET_URL}}system/hplus/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="{{ASSET_URL}}system/hplus/js/plugins/flot/jquery.flot.resize.js"></script>

    <!-- ChartJS-->
    <script src="{{ASSET_URL}}system/hplus/js/plugins/chartJs/Chart.min.js"></script>
...
<!-- Mirrored from www.zi-han.net/theme/hplus/index_v5.html by HTTrack Website Copier/3.x [XR&CO'2010], Sun, 06 Sep 2015 05:15:39 GMT -->
</html>